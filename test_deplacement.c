...
int reset_plateau(void)
{
    ...
    plateau[0][0].piece = plateau[0][7].piece = "tb";
    plateau[0][1].piece = plateau[0][6].piece = "cb";
    plateau[0][2].piece = plateau[0][5].piece = "fb";
    plateau[0][3].piece = "db";
    plateau[0][4].piece = "rb";
    ...
    plateau[7][0].piece = plateau[7][7].piece = "tn";
    plateau[7][1].piece = plateau[7][6].piece = "cn";
    plateau[7][2].piece = plateau[7][5].piece = "fn";
    plateau[7][3].piece = "dn";
    plateau[7][4].piece = "rn";

                            // Pions noirs
    for (i = 0; i < 8 ; i++)
    {
        plateau[6][i].piece = "pn";
    }
