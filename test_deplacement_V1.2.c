...
int cavalier( int y, int x, int *deplacement)
{
	...
	{
		//arriere
		if((strcmp(plateau[y+1][x+2].piece, "00") == 0 || plateau[y+1][x+2].piece[1] == 'n') && (y+1 !=8) && (x+2 != 8))
		{
			deplacement[j] = y+1;
			j++;
			deplacement[j] = x+2;
		...
		if((strcmp(plateau[y-1][x+2].piece,"00") == 0 || plateau[y-1][x+2].piece[1] == 'n') && (y-1 != 0) && (x+2 != 8))
		{
			deplacement[j] = y-1;
			j++;
			deplacement[j] = x+2;
		...
		//droite
		if((strcmp(plateau[y+2][x+1].piece, "00") == 0 || plateau[y+2][x+1].piece[1] == 'n') && (y+2 !=8) && (x+1 != 8))
		{
			deplacement[j] = y+2;
			j++;
			deplacement[j] = x+1;
		...
		if((strcmp(plateau[y+2][x-1].piece, "00") == 0 || plateau[y+2][x-1].piece[1] == 'n') && (y+2 != 8) && (x-1 != 0))
		{
			deplacement[j] = y+2;
			j++;
			deplacement[j] = x-1;
		...
		//gauche
		if((strcmp(plateau[y-2][x+1].piece, "00") == 0 || plateau[y-2][x+1].piece[1] == 'n') && (y-2 !=0) && (x+1 != 8))
		{
			deplacement[j] = y-2;
			j++;
			deplacement[j] = x+1;
		...
		if((strcmp(plateau[y-2][x-1].piece, "00") == 0 || plateau[y-2][x-1].piece[1] == 'n') && (y-2 != 0) && (x-1 != 0))
		{
			deplacement[j] = y-2;
			j++;
			deplacement[j] = x-1;
		...
		//avant
		if((strcmp(plateau[y+1][x-2].piece,"00") == 0 || plateau[y+1][x-2].piece[1] == 'n') && (y+1 !=8) && (x-2 != 0))
		{
			deplacement[j] = y+1;
			j++;
			deplacement[j] = x-2;
		...
		if((strcmp(plateau[y-1][x-2].piece, "00") == 0 || plateau[y-1][x-2].piece[1] == 'n') && (y-1 != 0) && (x-2 != 0))
		{
			deplacement[j] = y-1;
			j++;
			deplacement[j] = x-2;
	...
	{
		//avant
		if((strcmp(plateau[y+1][x+2].piece,"00") == 0 || plateau[y+1][x+2].piece[1] == 'b') && (y+1 !=8) && (x+2 != 8))
		{
			deplacement[j] = y+1;
			j++;
			deplacement[j] = x+2;
		...
		if((strcmp(plateau[y-1][x+2].piece, "00") == 0 || plateau[y-1][x+2].piece[1] == 'b') && (y-1 != 0) && (x+2 != 8))
		{
			deplacement[j] = y-1;
			j++;
			deplacement[j] = x+2;
		...
		//gauche
		if((strcmp(plateau[y+2][x+1].piece,"00") == 0 || plateau[y+2][x+1].piece[1] == 'b') && (y+2 !=8) && (x+1 != 8))
		{
			deplacement[j] = y+2;
			j++;
			deplacement[j] = x+1;
		...
		if((strcmp(plateau[y+2][x-1].piece, "00") == 0 || plateau[y+2][x-1].piece[1] == 'b') && (y+2 != 8) && (x-1 != 0))
		{
			deplacement[j] = y+2;
			j++;
			deplacement[j] = x-1;
		...
		//droite
		if((strcmp(plateau[y-2][x+1].piece,"00") == 0 || plateau[y-2][x+1].piece[1] == 'b') && (y-2 !=0) && (x+1 != 8))
		{
			deplacement[j] = y-2;
			j++;
			deplacement[j] = x+1;
		...
		//deriere
		if((strcmp(plateau[y+1][x-2].piece, "00") == 0 || plateau[y+1][x-2].piece[1] == 'b') && (y+1 !=8) && (x-2 != 0))
		{
			deplacement[j] = y+1;
			j++;
			deplacement[j] = x-2;
		...
		if((strcmp(plateau[y-1][x-2].piece,"00") == 0 || plateau[y-1][x-2].piece[1] == 'b') && (y-1 != 0) && (x-2 != 0))
		{
			deplacement[j] = y-1;
			j++;
			deplacement[j] = x-2;
